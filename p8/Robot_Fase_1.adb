...
procedure Robot_Fase_1 is
   ...
   begin
      case Paso mod 6 is
         when 0 =>
            return (True, False, False);   -- Obstáculo

         when 1 =>
            return (False, True, False);   -- Camino libre

         when 2 =>
            return (False, False, True);   -- Batería baja

         when 3 =>
            return (True, True, False);    -- Obstáculo + libre

         when 4 =>
            return (True, False, True);    -- Obstáculo + batería baja

         when others =>
            return (False, True, True); -- Camino libre + batería baja
      end case;
   end Leer_Sensores;
